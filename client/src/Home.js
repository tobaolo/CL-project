...
import { GoogleMap, withScriptjs, withGoogleMap, OverlayView, Polygon } from "react-google-maps";
  ...
  render() {
    return (
      <React.Fragment>
        ...
        <WrappedMap 
            googleMapURL={'https://maps.googleapis.com/maps/api/js?key=AIzaSyB45a2xoq_9DskmFsrLCMQFmXdsH2ycufc&libraries=gemoetry,drawing,places&callback=initMap'}
